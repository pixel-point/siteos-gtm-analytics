...
export function metadata(versions) {
  return [
    ...
    'documentation: "https://github.com/pixel-point/siteos-gtm-analytics#installation"',
...
export function validateTemplate(template) {
  ...
  assert.ok(info.categories?.includes("ANALYTICS"), "missing Gallery category");
...
if (process.argv[1] && fs.realpathSync(process.argv[1]) === fileURLToPath(import.meta.url)) {
  ...
  console.log("Analytics GTM distribution verified.");
}
